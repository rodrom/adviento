...
use Rodrom\Advent202215\CoordinateMap;
use Rodrom\Advent202215\Device;

class CalcRangeImpossibleCoordinatesTest extends TestCase
{
    public function test_simple_range_impossible_beacon(): void
    {
        ...
        $forbiddenResults = $device->forbiddenSensorsRange($y);
    ...
    public function test_one_sensor_get_impossible_range(): void
    {
        ...
        $forbiddenCoordinates = $device->forbiddenCoordinatesRange($y);
    ...
    public function test_custom_example(): void
    {
        ...
        $this->assertEquals(4, $forbiddenCoordinates, "CUSTOM LINE 0"); // Delete Sensors in Range
        ...
        $this->assertEquals(4, $forbiddenCoordinates, "CUSTOM LINE 4");
